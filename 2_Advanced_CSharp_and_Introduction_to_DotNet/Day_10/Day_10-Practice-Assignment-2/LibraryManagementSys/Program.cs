...
namespace LibraryManagementSys {
    class Program {
        static void Main() {
            ...
            lib.AddBook(new Book("Wings of Fire", "Nandini", "111"));
            lib.AddBook(new Book("The White Tiger", "Ashutosh", "222"));
            lib.RegisterBorrower(new Borrower("Sunali", "C001"));
            lib.RegisterBorrower(new Borrower("Rishabh", "C002"));
